...
//		System.out.println(sister_1());
		// 오류 발생! he method println(boolean)
		// in the type PrintStream is not applicable for the arguments (void)
		
	System.out.println("--------------------------------");
	
	    // 2. 파라미터는 없고, 리턴값만 있는 메서드 호출
	System.out.println("동생아! 물을 좀 떠 와라!");
	sister_2();
...
//	 * }
	...
	// -> 리턴값이 없으므로 리턴 타입 부분에 특수한 데이터 타입 void 타입을 명시
	// -> 리턴값이 없다는 의미
	...
	//       리턴 타입 부분에 명시(문자열을 리턴하려면 String 타입을 명시)
