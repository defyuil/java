...
public class Ex3 {
	public static void main(String[] args) {
		...
		System.out.println("Manage 정보: " + man.getManager());
		man.salaryCalculation();
		
		System.out.println("-------------------------------");
		
		Engineer eng = new Engineer("강감찬", 5000, 5);
		System.out.println("Engineer 정보: "+ eng.getEnginner());
...
//		}
		...
		//    (상속으로 인한 is-a 관계이므로!)
		// -> 모두 true가 되어 아래의 else if 조건으로 내려가지 않고 if블럭이 실행됨
...
//			Manager man = emp; // 자동형변환 불가! 강제형변환 필수!
			...
			// 다운캐스팅된 Manager 타입 인스턴스를 통해 모든 멤버변수 접근 가능
