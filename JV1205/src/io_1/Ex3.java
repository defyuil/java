...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * - read() 메서드를 호출하여 입력데이터를 char 단위(2Btyte) 만큼 읽어와서 저장
		 ...
		 *   => 읽어 온 데이터를 문자로 변환하는 후속작업 필요
		 * - InputStream보다는 유용하지만 여전히 낮은 수준의 입력 처리 방식
		 * 
		 * < 기본 문법 >
		 * InputStreamReader reader = new InputStreamReader(InpurStream 객체);
		 */
