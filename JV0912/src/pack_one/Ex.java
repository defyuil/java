...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - import 문은 패키지 키워드 보다 아래쪽, 클래스 선언부보다 위쪽에
		 *   위치하며 package 문과 달리 여러번 작성 가능
...
//		java.util.Random r;
		...
		// => 오류 발생! 인스턴스가 생성되지 않음!
		// => Ex.java 가 위치한 pack_one 패지키 내에 ExPack.java 가 
		//    위치하지 않기 때문
		// => import 문을 통해 ExPack.java 가 있는 pack_two, pack_three
		//    패키지를 등록해줘야 한다!
		
		// 만약, 서로 다른 패키지에 동일한 클래스명이 존재할 경우
		// import 문을 통해 포함시키더라도 각 클래스 구분을 위해
		// 최소 하나의 클래스는 패지명까지 명시해야 한다!
