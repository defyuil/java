...
public class Ex {
	...
	public static void main(String[] args) {
		/*
		 * 화면에 데이터를 출력하는 print(), printf(), println() 메소드
		 * - System.out.XXX() 메소드 형태로 사용
		 * 
		 * 1. println() 메소드
		...
		System.out.println("Hello, Wolrd!"); // "Hello, World!" 출력 후 줄바꿈
		System.out.println("임소언"); // "임소언" 출력 후 줄바꿈
		
		int age = 21;
		System.out.println("나이는 age세입니다.");
		// -> age가 문자열로 취급됨
		// -> 만약 age라는 변수를 사용하고 데이터를 활용해야 하는 경우
	...
	//	System.out.printf(1);
		...
		System.out.printf("오늘 날짜는 %d년 %02월 %d입니다.",2023, 7, 25);
		// -> %d 기호가 3개이므로, 데이터 3개가 순서대로 대입됨
		
		System.out.println();
		
		// %f: 실수 표현
		// %.xf: 실수 표현(소수점 x자리만큼만 표시)
