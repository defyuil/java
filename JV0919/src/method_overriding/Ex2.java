...
class Child extends Parent {
	...
	// -> 슈퍼크랠스가 가진 parentPrn1() 메서드는 child 인스턴스에서 보이지 않음!
	public void parentPrn1() {
		System.out.println("서브클래스에서 오버라이딩 된 parentPrn1()");
	}
	
	// 오버라이딩 시 슈퍼클래스의 접근제한자보다 좁아질 수 없다!
	// -> 부모가 public 일 경우 자식은 무조건 public 만 지정 가능!
...
//	}
	...
	public String parentPrn2() { // -> String 변경 가능!
...
//	}
	...
	// 주의! @Override 어노테이션(Annoitation)이 붙어 있을 경우에는
