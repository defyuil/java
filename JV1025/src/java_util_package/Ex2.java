...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *   -> 다양한 API들이 여전히 Date 타입을 사용하는 경우가 많음
		...
		Date d2 = new Date(1698200000000L); // 밀리초 단위 long 타입 값을 전달
		// -> 기준 시각으로부터 지정된 밀리초만큼 지난 시각으로 설정
		System.out.println(d2);
		
		// Date 객체의 getTime() 메서드를 호출하면
		// 해당 객체의 날짜 정보가 long 타입으로 리턴ㄴ됨
		// => 두 Date 객체의 getTime() 결과를 연산하면 두 날짜간의 차이 계산 가능
		// => 목표 날짜 - 현재 날짜 > 0 일 경우 결과값은 남은 일수(미래)이며,
		//    목표 날짜 - 현재 날짜 < 0 일 경우 결과값은 지난 일수(과거)이다.
