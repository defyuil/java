...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *   long(8Byte = 64bit) : 2^64 = dir -922경 ~ +922경
		 *   
...
//		b = 100;
		...
		b = 127;
//		b = 128; // 오류 발생! byte 타입에 저장 가능한 수 -128 ~ +127까지
		...
		s = 32767;
//		s = 32768;
		// - > 오류 발생! short 타입 저장 가능한 수 - 32768 ~ +32767까지
...
//		 float f = 3.14; // 오류 발생!
		// -> 접미사가 없으면 double 타입으로 인식되므로 float 타입 변수 저장 불가
		 ...
		 // 논리형 데이터타입
		 // boolean 데이터타입: 특수한 값인 true 또는 false만 사용가능
		 boolean bool = true;
