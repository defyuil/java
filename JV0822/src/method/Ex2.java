...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		sister_3(2000); // 메서드 파라미터에 리터럴값 직접 전달하거나
		...
		System.out.println("동생아! 1만원을 줄 테니 내 사우깡도 사 줘!");
	...
	public static void sister_3(int money) {
		...
		money -= 1000;
		System.out.println("동생: 새우깡 사 먹고" + money + "원이 남았다.");
