...
public class Ex5 {
	...
	public static void main(String[] args) {
		 ...
		 * - 주의! 동등 비교 연산자는 수학(=) 과는 달리 '==' 형태의 기호 사용
...
//		int result = a > b; // 결과값이 true or false이므로 int형 변수에는 저장 불가
		// -> a > b의 결과(true)를 boolean 타입 변수 result 에 저장
		...
		// 주의! double 타입과 float타입 비교 시
		System.out.println(0.1 == 0.1f); // false, 같은 값이나 다른 값으로 취급한다
		
		System.out.println((float)0.1); // true
